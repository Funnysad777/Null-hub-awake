...
local upgrades = {
    ...
    {name = "Green Laser CameraMan2", gold = 400, position = CFrame.new(3.23119831, -33.6337891, -18.9258442, 1, 0, 0, 0, 1, 0, 0, 0, 1), angles = CFrame.Angles(-3.1415927410125732, 0.3082665503025055, -3.1415927410125732), tower = "Green Laser CameraMan"},
